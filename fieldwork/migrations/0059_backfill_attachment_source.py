# Generated by Django 3.2.14 on 2022-07-22 16:34
...
class Migration(migrations.Migration):
    dependencies = [
        ('fieldwork', '0058_make_source_type_unique'),
    ]

    operations = [
        migrations.RunSQL(
            '''
           Update fieldwork_attachment fa
            set source_id = (
              select id from fieldwork_attachmentsourcetype fas
              where fas.name = 'object'
              limit 1)
        ...
        set source_id = (
          select id from fieldwork_attachmentsourcetype fas
          where fas.name = 'other'
          limit 1)
        where fa.source_id is null; 
            ''',
            reverse_sql='',
        )
    ]
